...
const UserActivetedServicesArea = ({route}: {route: any}) => {
  ...
  const handlePress = (serviceId: string) => {
    navigation.navigate('UserActivetedServices', {
      serviceId, // Pass serviceId directly
    });
  };

  const renderAppointment = ({item}: {item: Appointment}) => (
    <TouchableOpacity onPress={() => handlePress(item.serviceId)}>
...
export default UserActivetedServicesArea;
