      ...
      <View style={styles.container}>
        ...
        <View style={styles.section}>
          <View style={styles.row}>
            ...
            <TouchableOpacity onPress={openPhone}>
              <Ionicons name="call" size={normalize(20)} color="blue" />
            </TouchableOpacity>
          </View>
        ...
        <View style={styles.section}>
          <View style={styles.row}>
            ...
            <TouchableOpacity onPress={openMap}>
              <Ionicons name="location" size={normalize(20)} color="blue" />
            </TouchableOpacity>
          </View>
        ...
        <View style={styles.section}>
          <TouchableOpacity
            ...
            onPress={() => handleServiceStatusUpdate(2)}>
            <Text style={styles.buttonText}>Kabul Et</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.rejectButton}
            onPress={() => handleServiceStatusUpdate(4)}>
...
export default BPendingServiceDetails;
